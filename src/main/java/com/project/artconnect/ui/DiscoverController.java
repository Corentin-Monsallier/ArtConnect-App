 ...
 * workshopService.getAllWorkshops().stream().limit(3).forEach(this::
 * addWorkshopCard);
 * }
 * 
 ...
 * new Label("Gallery: " + (e.getGallery() != null ? e.getGallery().getName() :
 * "Unknown")));
 ...
 * }
 * },
 * new Label("Instructor: " + (w.getInstructor() != null ?
 * w.getInstructor().getName() : "Unknown")),
