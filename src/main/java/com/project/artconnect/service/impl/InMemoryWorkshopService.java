 ...
 * artistService.getArtistByName("Leonardo Vinci").orElse(null), 150.0,
 * "Intermediate", "Florence Studio");
 * addWorkshop("Impressionist Landscapes", LocalDateTime.now().plusDays(10),
 * artistService.getArtistByName("Claude Monet").orElse(null), 120.0,
 * "Beginner", "Giverny Gardens");
 * addWorkshop("Sculpting Modernity", LocalDateTime.now().plusDays(15),
 * artistService.getArtistByName("Auguste Rodin").orElse(null), 200.0,
 * "Advanced", "Paris Workshop");
 * }
 * 
 * private void addWorkshop(String title, LocalDateTime date, Artist instructor,
