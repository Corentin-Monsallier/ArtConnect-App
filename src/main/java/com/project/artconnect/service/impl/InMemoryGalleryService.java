 ...
 * Gallery british = addGallery("The British Gallery",
 * "Great Russell St, London", 4.7);
 * Gallery met = addGallery("Metropolitan Hub", "1000 5th Ave, New York", 4.8);
 * 
 * // Add Exhibitions
 * addExhibition("Renaissance Revival", LocalDate.now().minusMonths(1),
 * LocalDate.now().plusMonths(2), louvre,
 ...
 * 
 * addExhibition("Sculpting the Soul", LocalDate.now().minusDays(15),
 * LocalDate.now().plusMonths(1), british,
 * "Marcus Thorne", "Modern & Classical Sculpture",
 * artworkService.getArtworkByTitle("The Thinker").orElse(null));
 * 
 * addExhibition("Impressionist Dreams", LocalDate.now().minusMonths(2),
 * LocalDate.now().plusMonths(3), met,
 ...
 * Gallery gallery, String curator,
