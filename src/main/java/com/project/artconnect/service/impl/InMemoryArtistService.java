 ...
 * 
 * // Artists
 * addArtist("Leonardo Vinci", "Renaissance master and polymath.", 1452,
 * "leo@vincistudio.it", "Florence",
 * "Painting", "Sculpture");
 * addArtist("Claude Monet", "Founder of French Impressionist painting.", 1840,
 * "claude@monet.fr", "Giverny",
 * "Painting");
 * addArtist("Ansel Adams",
 * "American landscape photographer and environmentalist.", 1902,
 * "ansel@adams.co",
 * "San Francisco", "Photography");
 * addArtist("Frida Kahlo",
 * "Mexican painter known for her many portraits and self-portraits.", 1907,
 * "frida@kahlo.mx", "Mexico City", "Painting");
 * addArtist("Auguste Rodin",
 * "French sculptor, generally considered the founder of modern sculpture.",
 * 1840,
 ...
 * }
 * 
 * private void addArtist(String name, String bio, int year, String email,
 * String city, String... disciplineNames) {
 ...
 * 
 * @Override
 * public List<Artist> searchArtists(String query, String disciplineName, String
 * city) {
 ...
 * || a.getDisciplines().stream().anyMatch(d ->
 * d.getName().equals(disciplineName)))
